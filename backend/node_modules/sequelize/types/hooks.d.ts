...
import { AbstractQuery } from 'sequelize/lib/dialects/abstract/queryabstract/query';
import { QueryOptions } from 'sequelize/lib/dialects/abstract/query-interfaceuery-interface';
import { Config, Options, Sequelize, SyncOptions } from 'sequelize/lib/sequelizeypes/sequelize';
import { DeepWriteable } from 'sequelize/lib/utilsze/types/utils';
import { Connection, GetConnectionOptions } from 'sequelize/lib/dialects/abstract/connection-managerection-manager';
