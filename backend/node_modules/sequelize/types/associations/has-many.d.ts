...
import {
  ...
  ModelCtor,
  Transactionable,
} from 'sequelize/lib/modele/types/model';
import { Association, ManyToManyOptions, MultiAssociationAccessors } from 'sequelize/lib/associations/baseize/types/associations/base';
