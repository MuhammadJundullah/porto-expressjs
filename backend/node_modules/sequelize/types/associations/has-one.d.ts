import { DataType } from 'sequelize/lib/data-typeses/data-types';
import { CreateOptions, CreationAttributes, FindOptions, Model, ModelCtor, SaveOptions } from 'sequelize/lib/modele/types/model';
import { Association, AssociationOptions, SingleAssociationAccessors } from 'sequelize/lib/associations/baseize/types/associations/base';
