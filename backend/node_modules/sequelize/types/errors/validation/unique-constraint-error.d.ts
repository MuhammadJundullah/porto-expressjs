import { CommonErrorProperties, ErrorOptions } from 'sequelize/lib/errors/base-errores/errors/base-error';
import ValidationError, { ValidationErrorItem } from 'sequelize/lib/errors/validation-errorors/validation-error';
