import type { Model } from 'sequelizequelize/types';
import type { ErrorOptions } from 'sequelize/lib/errors/base-errorpes/errors/base-error';
import BaseError from 'sequelize/lib/errors/base-errorpes/errors/base-error';
/**
